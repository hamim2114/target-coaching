    ...
    return (
        <section id='event' className='md:py-[8rem] py-[3rem]'>
            <div className='sm:mx-[14rem] px-6'>
                <div data-aos='fade-up' className=' border-l-2 border-green-500 pl-6'>
                    <h1 data-aos='fade-right' className='text-5xl font-bold mb-2'> <span className='text-green-500'>Our</span> Event</h1>
                    <p data-aos='fade-right' data-aos-delay='200' className='mb-8'>amet consectetur adipisicing elit. Quos beatae itaque <br className='hidden md:block' /> accusantium quas voluptas iusto.adipisicing elit. Quos beatae</p>
                </div>
