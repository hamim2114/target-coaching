...
const Hero = () => {
  ...
  return (
    <section id="home">
      <div className="w-full h-[700px]  absolute bg-gray-900/50">
      ...
      <div className="relative sm:px-[4rem] xl:px-[15rem] px-6 w-full md:pt-[12rem] pt-[6rem]">
        <div className="text-white mt-14">
          <h6 className="animate__animated animate__fadeInUp h-[26px] text-xl md:text-2xl">
            <Typewriter
              typeSpeed={50}
              deleteSpeed={4}
          ...
          <h1 className="animate__animated animate__slideInLeft animate__slow md:text-7xl text-6xl font-bold md:my-3">
